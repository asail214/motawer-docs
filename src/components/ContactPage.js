            ...
            <Card className="feature-card h-100">
              <Card.Body>
                ...
                <div className="contact-intro mb-4">
                  <h5 style={{color: 'var(--primary-color)'}}>أصايل الشكيلية</h5>
                  <p className="text-muted">
                    مصممة UI/UX ومطورة Front-End | متدربة Full-Stack Developer
                  </p>
                  <p>
                    مطورة مستقلة ومدربة تقنية في نفس الوقت، متخصصة في تطوير الواجهات الأمامية وتصميم تجربة المستخدم. 
                    أحب مشاركة المعرفة وتعليم البرمجة لمساعدة المطورين العرب على التطور في مجال التقنية.
                  </p>
                </div>
                ...
                <Alert variant="info" className="mt-4">
                  <Alert.Heading>حاليا</Alert.Heading>
                  <p className="mb-0">
                    📚 خريجة برنامج Makeen Bootcamp لتطوير Full-Stack<br />
                    💼 متاح للعمل الحر في مشاريع UI/UX و Front-End Development<br />
                    🎓 خريجة علوم حاسوب من جامعة السلطان قابوس 2025
                  </p>
                </Alert>
              </Card.Body>
            </Card>
          ...
          <Col lg={6} className="mb-4">
            <Card className="feature-card">
              <Card.Body>
                ...
                <p>
                  بالطبع! أقدم جلسات استشارية عن بعد لمساعدة المطورين في المشاريع سواء كانت أسئلة تقنية أو مراجعة كود. 
          ...
          <Col lg={6} className="mb-4">
            <Card className="feature-card">
              <Card.Body>
                ...
                <p>
                  أقدم جلسات تدريب في مجال وتطوير الواجهات. تواصل معي لمناقشة 
